...
- [ ] 14.1 创建 docs/DEPLOYMENT.md
- [ ] 14.2 编写本地开发环境搭建指南
- [ ] 14.3 编写 Web UI 部署流程（npm run build）
- [ ] 14.4 编写 CLI 工具安装流程（npm link 或 npm install -g）
- [ ] 14.5 说明配置文件位置和格式
- [ ] 14.6 添加故障排查章节（常见问题和解决方案）
- [ ] 14.7 添加日志文件位置说明
- [ ] 14.8 添加备份和恢复流程

## 15. CLI 参考文档

- [ ] 15.1 创建 docs/CLI_REFERENCE.md
- [ ] 15.2 文档化 init 命令（语法、选项、示例）
- [ ] 15.3 文档化 analyze 命令（包括 --now 选项）
- [ ] 15.4 文档化 review 命令（包括 -v/--verbose 选项）
- [ ] 15.5 文档化 approve 命令（单个和 all）
- [ ] 15.6 文档化 reject 命令
- [ ] 15.7 文档化 config 命令（list/set）
- [ ] 15.8 文档化新增的 status 命令
- [ ] 15.9 文档化新增的 history 命令
- [ ] 15.10 文档化新增的 diff 命令
- [ ] 15.11 添加每个命令的实际使用示例
